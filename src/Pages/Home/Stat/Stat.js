        ...
        <div class="container">
          <div class="row pb-5">
            <div class="position-relative col-12 col-md-6 col-lg-3 mb-16 mb-lg-0">
              <img
                class="d-none d-md-block position-absolute top-0 start-50 ms-16 ms-lg-8"
            ...
            <div class="position-relative col-12 col-md-6 col-lg-3 mb-16 mb-lg-0">
              <img
                class="d-none d-lg-block position-absolute top-0 start-50 ms-8"
                src="yofte-assets/elements/dots.svg"
                alt=""
              />
              <div class="position-relative text-center">
                <span
                  class="d-inline-flex mb-16 align-items-center justify-content-center bg-white rounded-circle"
                  style={{ width: "80px", height: "80px" }}
                >
                  <svg
                    width="39"
